...
class _MenuDetailState extends State<MenuDetail> {
  ...
  void initState() {
    ...
    super.initState();
    getMenuDetails("23", StoreFragment.storeId, MenuCategory.storeMenuId)
        .then((menuDetails) {
      setState(() {
        ...
        body: Container(
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(
                    width: 5, color: Color.fromARGB(255, 128, 125, 125)),
          ...
          Container(
              ...
              child: Center(
                ...
                child: const Text('Add to Bag', style: TextStyle(fontSize: 20)),
                onPressed: () {},
              ))),
        ])));
  }
